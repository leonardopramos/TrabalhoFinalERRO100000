public class BinaryTree {  
    ...
    public static void main(String[] args) {  
        ...
        bt.root.right.right.right.right = new Node(5);  
        bt.root.right.right.right.right.right = new Node(6);  
        bt.root.right.right.right.right.right.right= new Node(7);  
        bt.root.right.right.right.right.right.right.right = new Node(8);  
