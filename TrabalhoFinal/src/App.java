...
public class App {
    ...
    public static void main(String[] args) {
        ...
        if(ap.estaBalanceada(ap.getRaiz()) > 0){
        ...
        for(;;){
            ...
            //procuraArvoreItem
            if(ap.consultar(itemProcurado)){
                System.out.println();
                System.out.println("A Arvore contém o item procurado!");
                System.out.println("Item buscado na árvore: " + ap.get(itemProcurado, ap.getRaiz()).toString() + "\n");
            }else {
                System.out.println("Item não encontrado.");
            }
            //procuraListaItem
            if(lst.consultar(itemProcurado)){
